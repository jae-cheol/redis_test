...
public final class RdbParser implements AutoCloseable {
  ...
  private void readFreq() throws IOException {
    nextEntry.setFreq(readByte());
  }

  private void readIdle() throws IOException {
    nextEntry.setIdle(readLength());
  }
  ...
  private void readZSetListPack() throws IOException {
    nextEntry.setValueType(ValueType.SORTED_SET_AS_LISTPACK);
    nextEntry.setValues(new SortedSetAsListpack(readStringEncoded()));
  }

  private void readValue() throws IOException {
    nextEntry.setValueType(ValueType.VALUE);
    nextEntry.setValues(Arrays.asList(readStringEncoded()));
  }
  ...
  private void readList() throws IOException {
    ...
    nextEntry.setValueType(ValueType.LIST);
    nextEntry.setValues(list);
  }
  ...
  private void readSet() throws IOException {
    ...
    nextEntry.setValueType(ValueType.SET);
    nextEntry.setValues(set);
  }
  ...
  private void readSortedSet() throws IOException {
    ...
    nextEntry.setValueType(ValueType.SORTED_SET);
    nextEntry.setValues(valueScoresPairs);
  }
  ...
  private void readSortedSet2() throws IOException {
    ...
    nextEntry.setValueType(ValueType.SORTED_SET2);
    nextEntry.setValues(valueScoresPairs);
  }
  ...
  private void readHash() throws IOException {
    ...
    nextEntry.setValueType(ValueType.HASH);
    nextEntry.setValues(kvPairs);
  }

  private void readZipMap() throws IOException {
    nextEntry.setValueType(ValueType.ZIPMAP);
    nextEntry.setValues(new ZipMap(readStringEncoded()));
  }

  private void readZipList() throws IOException {
    nextEntry.setValueType(ValueType.ZIPLIST);
    nextEntry.setValues(new ZipList(readStringEncoded()));
  }

  private void readIntSet() throws IOException {
    nextEntry.setValueType(ValueType.INTSET);
    nextEntry.setValues(new IntSet(readStringEncoded()));
  }

  private void readSortedSetAsZipList() throws IOException {
    nextEntry.setValueType(ValueType.SORTED_SET_AS_ZIPLIST);
    nextEntry.setValues(new SortedSetAsZipList(readStringEncoded()));
  }

  private void readHashmapAsZipList() throws IOException {
    nextEntry.setValueType(ValueType.HASHMAP_AS_ZIPLIST);
    nextEntry.setValues(new ZipList(readStringEncoded()));
  }

  private void readHashListPack() throws IOException {
    nextEntry.setValueType(ValueType.HASHMAP_AS_LISTPACK);
    nextEntry.setValues(new ListpackList(readStringEncoded()));
  }
  ...
  private void readQuickList2() throws IOException {
    ...
    nextEntry.setValueType(ValueType.QUICKLIST2);
    nextEntry.setValues(new QuickList2(listpacks));
  }
  ...
  private void readQuickList() throws IOException {
    ...
    nextEntry.setValueType(ValueType.QUICKLIST);
    nextEntry.setValues(new QuickList(ziplists));
  }
